...
db.products.insertMany([
	...
	{'name': 'Gigabyte H310M S2H', 'description': 'Материнская плата ASUS ROG MAXIMUS X HERO, Z370, Socket 1151-V2, DDR4, ATX', 'price': '4790.00', 'catalog_id': 'Материнские платы', 'created_at': new Date(), 'updated_at': new Date()},
	{'name': 'MSI B250M GAMING PRO', 'description': 'Материнская плата ASUS ROG MAXIMUS X HERO, Z370, Socket 1151-V2, DDR4, ATX', 'price': '5060.00', 'catalog_id': 'Материнские платы', 'created_at': new Date(), 'updated_at': new Date()}])
